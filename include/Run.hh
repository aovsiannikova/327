...
// count different primary gamma interaction
...
// count photons absorbed in SiPM
    void AddSiPMOpAbsorption(void) {fSiPMOpAbsorption += 1;}

// count photons absorbed in Scintillator
    void AddScOpAbsorption(void) {fScOpAbsorption += 1;}

    // count photons absorbed directly
    void AddOpAbsorptionPrior(void) {fOpAbsorptionPrior += 1;}
    // count photons absorbed directly in SiPM
    void AddOpAbsorptionPriorSiPM(void) {fOpAbsorptionPriorSiPM += 1;}
    // count photons absorbed directly in CeBr3
    void AddOpAbsorptionPriorScint(void) {fOpAbsorptionPriorScint += 1;}
